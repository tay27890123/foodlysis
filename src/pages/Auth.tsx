...
import { Leaf, ArrowLeft, Truck, ShoppingCart } from "lucide-react";
      ...
      >
        ...
        <div className="glass-card p-8 border border-border/50">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            {isSignUp ? "Join Malaysia's B2B food surplus marketplace" : "Sign in to your account"}
          </p>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full mb-4 h-11 gap-3 font-medium"
              ...
              >
                <div>
                  ...
                  <Input
                    ...
                    required
                    placeholder="e.g. Cameron Highlands Farms"
                    className="h-11"
                  />
                </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-4">
          By continuing, you agree to Foodlysis Terms of Service and Privacy Policy.
        </p>
      </motion.div>
    </div>
  );
